        ...
        return (React.createElement("div", null,
            ...
            React.createElement("div", { className: "harmovis_area" },
                React.createElement(HarmoVisNonMapLayers, { viewport: viewport, actions: actions, layers: [
                        new FixedPointLayer({
                            depotsData: depotsData, onHover: onHover
                        }),
                        new MovesNonmapLayer({
                            movedData: movedData, movesbase: movesbase, actions: actions, routePaths: routePaths, clickedObject: clickedObject, onHover: onHover
                        }),
                        new LineMapLayer({
                            linemapData: linemapData, onHover: onHover
                        })
                    ] })),
