...
var ElapsedTimeValue = /** @class */ (function (_super) {
    ...
    ElapsedTimeValue.prototype.setTime = function (e) {
        ...
        var _a = this.props, actions = _a.actions, timeLength = _a.timeLength, min = _a.min;
    ...
    ElapsedTimeValue.prototype.render = function () {
        var _a = this.props, settime = _a.settime, timeLength = _a.timeLength, min = _a.min, id = _a.id, className = _a.className;
        return (React.createElement("input", { type: "number", value: Math.floor(settime), min: min, max: timeLength, onChange: this.setTime.bind(this), id: id, className: className }));
    };
