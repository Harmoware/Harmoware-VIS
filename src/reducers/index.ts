...
export const baseSlice = createSlice({
  ...
  initialState,
  reducers:{
		addMinutes:(state:BasedState, action:Action<number>)=>addMinutes(state,action.payload),
		setViewport:(state:BasedState, action:Action<Viewport>)=>setViewport(state,action.payload),
		setDefaultViewport:(state:BasedState, action:Action<{defaultZoom?:number,defaultPitch?:number}>)=>setDefaultViewport(state,action.payload),
		setTimeStamp:(state:BasedState, action:Action<BasedProps>)=>setTimeStamp(state,action.payload),
		setTime:(state:BasedState, action:Action<number>)=>setTime(state,action.payload),
		increaseTime:(state:BasedState, action:Action<BasedProps>)=>increaseTime(state,action.payload),
		decreaseTime:(state:BasedState, action:Action<BasedProps>)=>decreaseTime(state,action.payload),
		setLeading:(state:BasedState, action:Action<number>)=>setLeading(state,action.payload),
		setTrailing:(state:BasedState, action:Action<number>)=>setTrailing(state,action.payload),
		setFrameTimestamp:(state:BasedState, action:Action<BasedProps>)=>setFrameTimestamp(state,action.payload),
		setMovesBase:(state:BasedState, action:Action<(Movesbase[] | MovesbaseFile)>)=>setMovesBase(state,action.payload),
		setDepotsBase:(state:BasedState, action:Action<Depotsbase[]>)=>setDepotsBase(state,action.payload),
		setLocationData:(state:BasedState, action:Action<Readonly<LocationData>>)=>setLocationData(state,action.payload),
		setLocationDataOption:(state:BasedState, action:Action<LocationDataOption>)=>setLocationDataOption(state,action.payload),
		setAnimatePause:(state:BasedState, action:Action<boolean>)=>setAnimatePause(state,action.payload),
		setAnimateReverse:(state:BasedState, action:Action<boolean>)=>setAnimateReverse(state,action.payload),
		setSecPerHour:(state:BasedState, action:Action<number>)=>setSecPerHour(state,action.payload),
		setMultiplySpeed:(state:BasedState, action:Action<number>)=>setMultiplySpeed(state,action.payload),
		setClicked:(state:BasedState, action:Action<(null | ClickedObject[])>)=>setClicked(state,action.payload),
		setRoutePaths:(state:BasedState, action:Action<RoutePaths[]>)=>setRoutePaths(state,action.payload),
		setDefaultPitch:(state:BasedState, action:Action<number>)=>setDefaultPitch(state,action.payload),
		setMovesOptionFunc:(state:BasedState, action:Action<GetMovesOptionFunc>)=>setMovesOptionFunc(state,action.payload),
		setDepotsOptionFunc:(state:BasedState, action:Action<GetDepotsOptionFunc>)=>setDepotsOptionFunc(state,action.payload),
		setExtractedDataFunc:(state:BasedState, action:Action<GetExtractedDataFunc>)=>setExtractedDataFunc(state,action.payload),
		setLinemapData:(state:BasedState, action:Action<LineMapData[]>)=>setLinemapData(state,action.payload),
		setLoading:(state:BasedState, action:Action<boolean>)=>setLoading(state,action.payload),
		setInputFilename:(state:BasedState, action:Action<Object>)=>setInputFilename(state,action.payload),
		updateMovesBase:(state:BasedState, action:Action<Movesbase[]>)=>updateMovesBase(state,action.payload),
		setNoLoop:(state:BasedState, action:Action<boolean>)=>setNoLoop(state,action.payload),
		setInitialViewChange:(state:BasedState, action:Action<boolean>)=>setInitialViewChange(state,action.payload),
		setIconGradationChange:(state:BasedState, action:Action<boolean>)=>setIconGradationChange(state,action.payload),
		setTimeBegin:(state:BasedState, action:Action<number>)=>setTimeBegin(state,action.payload),
		setTimeLength:(state:BasedState, action:Action<number>)=>setTimeLength(state,action.payload),
		addMovesBaseData:(state:BasedState, action:Action<Movesbase[]>)=>addMovesBaseData(state,action.payload),
  }
})
