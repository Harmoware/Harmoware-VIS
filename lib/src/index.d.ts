import { BasedState, BasedProps, Bounds, ClickedObject, Depotsbase, DepotsData, IconDesignation, MovedData, Movesbase, MovesbaseOperation, RoutePaths, Viewport, LineMapData, ActionsInterface, EventInfo } from './types';
