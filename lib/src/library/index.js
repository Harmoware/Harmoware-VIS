...
export var analyzeMovesBase = function (state, inputData, update) {
    ...
    var movesbase = outputData.movesbase, elapsedtimeMode = outputData.elapsedtimeMode;
...
export var getDepots = function (props) {
    var settime = props.settime, depotsBase = props.depotsBase, prevData = props.depotsData, secperhour = props.secperhour, getDepotsOptionFunc = props.getDepotsOptionFunc;
