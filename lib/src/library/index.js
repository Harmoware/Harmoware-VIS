...
export var getDepots = function (props) {
    ...
    if (areadepots.length > 0 && typeof bounds !== 'undefined' && Object.keys(bounds).length > 0) {
        var depotsData = new Array(areadepots.length);
        for (var i = 0, lengthi = areadepots.length; i < lengthi; i += 1) {
            var _a = areadepots[i], type = _a.type, longitude = _a.longitude, latitude = _a.latitude, _b = _a.position, position = _b === void 0 ? [longitude, latitude, 1] : _b;
