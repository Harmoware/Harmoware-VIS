...
export var getDepots = function (props) {
    ...
    if (depotsBase.length > 0) {
        ...
        for (var i = 0, lengthi = depotsBase.length; i < lengthi; i = (i + 1) | 0) {
            ...
            depotsData[i] = Object.assign({}, otherProps, { settime: settime, position: position }, getOptionFunction(props, i));
        }
        return depotsData;
    }
    return [];
...
export var getMoveObjects = function (props) {
    ...
    for (var _i = 0, selectmovesbase_1 = selectmovesbase; _i < selectmovesbase_1.length; _i++) {
        ...
        if (typeof operation[idx].position === 'undefined' ||
            ...
            var _a = operation[idx], elapsedtime = _a.elapsedtime, longitude = _a.longitude, latitude = _a.latitude, color = _a.color, direction = _a.direction, otherProps2 = __rest(_a, ["elapsedtime", "longitude", "latitude", "color", "direction"]);
            movedData.push(Object.assign({}, otherProps1, otherProps2, { settime: settime, movesbaseidx: movesbaseidx }, getOptionFunction(props, movesbaseidx, idx)));
        }
        else {
            ...
            movedData.push(Object.assign({}, otherProps1, otherProps2, { settime: settime,
                position: position, sourcePosition: sourcePosition, targetPosition: targetPosition,
                color: sourceColor, direction: direction,
                sourceColor: sourceColor, targetColor: targetColor, movesbaseidx: movesbaseidx }, getOptionFunction(props, movesbaseidx, idx)));
        }
    }
    return movedData;
};
