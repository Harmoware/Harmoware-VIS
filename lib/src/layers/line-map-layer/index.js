...
var LineMapLayer = /** @class */ (function (_super) {
    ...
    LineMapLayer.prototype.renderLayers = function () {
        var _a = this.props, layerOpacity = _a.layerOpacity, linemapData = _a.linemapData, getStrokeWidth = _a.getStrokeWidth, getColor = _a.getColor;
        if (!linemapData) {
            return null;
        }
    ...
    LineMapLayer.defaultProps = {
        layerOpacity: 1.0,
        getStrokeWidth: function (x) { return x.strokeWidth || 100; },
