...
import { CompositeLayer, ScatterplotLayer, GridCellLayer, LineLayer, ArcLayer } from 'deck.gl';
...
var MovesLayer = /** @class */ (function (_super) {
    ...
    MovesLayer.prototype.renderLayers = function () {
        var _a = this.props, routePaths = _a.routePaths, layerRadiusScale = _a.layerRadiusScale, layerOpacity = _a.layerOpacity, movedData = _a.movedData, movesbase = _a.movesbase, clickedObject = _a.clickedObject, actions = _a.actions, optionElevationScale = _a.optionElevationScale, optionOpacity = _a.optionOpacity, optionCellSize = _a.optionCellSize, optionVisible = _a.optionVisible, optionChange = _a.optionChange, lightSettings = _a.lightSettings, getColor = _a.getColor, getRadius = _a.getRadius, visible = _a.visible, getColor1 = _a.getColor1, getColor2 = _a.getColor2, getColor3 = _a.getColor3, getColor4 = _a.getColor4, getElevation1 = _a.getElevation1, getElevation2 = _a.getElevation2, getElevation3 = _a.getElevation3, getElevation4 = _a.getElevation4, getCubeColor = _a.getCubeColor, getCubeElevation = _a.getCubeElevation, i18n = _a.i18n;
        ...
        return [
            ...
            new ArcLayer({
                ...
                getStrokeWidth: function (x) { return Math.max(x.strokeWidth * pixelsPerMeter[0], 1); },
                opacity: layerOpacity
            }),
        ];
    };
