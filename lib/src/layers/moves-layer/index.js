...
var MovesLayer = /** @class */ (function (_super) {
    ...
    MovesLayer.prototype.renderLayers = function () {
        ...
        var lineVisible = optionLineVisible !== undefined ? optionLineVisible : optionVisible;
        ...
        return [
            ...
            arcData.length > 0 && lineVisible ?
                new LineLayer({
                    ...
                    getSourcePosition: function (x) { return x.sourcePosition; },
                    getTargetPosition: function (x) { return x.targetPosition; },
                    getColor: function (x) { return x.sourceColor || x.color || COLOR1; },
    ...
    MovesLayer.defaultProps = {
        ...
        getLinehWidth: function (x) { return 10; },
