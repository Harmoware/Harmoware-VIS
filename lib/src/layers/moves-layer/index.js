...
var MovesLayer = /** @class */ (function (_super) {
    ...
    MovesLayer.prototype.getIconLayer = function () {
        var _a = this.props, id = _a.id, layerRadiusScale = _a.layerRadiusScale, layerOpacity = _a.layerOpacity, movedData = _a.movedData, getRadius = _a.getRadius, iconlayer = _a.iconlayer, iconChange = _a.iconChange, iconCubeType = _a.iconCubeType, visible = _a.visible, scenegraph = _a.scenegraph, mesh = _a.mesh, sizeScale = _a.sizeScale, getOrientation = _a.getOrientation, getScale = _a.getScale, getTranslation = _a.getTranslation, propIconDesignations = _a.iconDesignations;
