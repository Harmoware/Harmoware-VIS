...
var MovesNonmapLayer = /** @class */ (function (_super) {
    ...
    MovesNonmapLayer.prototype.renderLayers = function () {
        var _a = this.props, layerOpacity = _a.layerOpacity, actions = _a.actions, clickedObject = _a.clickedObject, movedData = _a.movedData, getColor = _a.getColor, propGetRadius = _a.getRadius, routePaths = _a.routePaths;
        if (!movedData) {
            return null;
        }
