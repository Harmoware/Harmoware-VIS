...
import { addMinutes, setViewport, setDefaultViewport, setLightSettings, setTimeStamp, setTime, increaseTime, decreaseTime, setLeading, setTrailing, setFrameTimestamp, setMovesBase, setDepotsBase, setAnimatePause, setAnimateReverse, setSecPerHour, setClicked, setRoutePaths, setDefaultPitch, setMovesOptionFunc, setDepotsOptionFunc, setLinemapData, setLoading, setInputFilename, updateMovesBase } from '../actions';
var initialState = {
    viewport: {
...
reducer.case(increaseTime, function (state, props) {
    ...
    if ((now - state.starttimestamp) > state.loopTime) {
        ...
        var setProps_1 = __assign({}, props, { settime: settime_1, starttimestamp: starttimestamp });
    ...
    var setProps = __assign({}, props, { settime: settime, beforeFrameTimestamp: beforeFrameTimestamp });
...
reducer.case(decreaseTime, function (state, props) {
    ...
    var beforeFrameTimestamp = now;
    var setProps = __assign({}, props, { settime: settime, starttimestamp: starttimestamp, beforeFrameTimestamp: beforeFrameTimestamp });
    var movedData = getMoveObjects(setProps);
    var depotsData = getDepots(setProps);
    return Object.assign({}, state, {
...
reducer.case(setFrameTimestamp, function (state, props) {
    ...
    var setProps = __assign({}, props, { beforeFrameTimestamp: beforeFrameTimestamp });
    var movedData = getMoveObjects(setProps);
    var depotsData = getDepots(setProps);
    return Object.assign({}, state, {
...
reducer.case(setMovesBase, function (state, base) {
    ...
    var setState = __assign({}, state, { bounds: bounds });
    var depotsData = getDepots(setState);
    var linemapData = state.linemapData;
    var lightSettings = Object.assign({}, state.lightSettings, { lightsPosition: [
...
reducer.case(setDepotsBase, function (state, depotsBase) {
    var setState = __assign({}, state, { depotsBase: depotsBase });
    var depotsData = getDepots(setState);
    return Object.assign({}, state, {
