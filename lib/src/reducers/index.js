...
import { addMinutes, setViewport, setDefaultViewport, setTimeStamp, setTime, increaseTime, decreaseTime, setLeading, setTrailing, setFrameTimestamp, setMovesBase, setDepotsBase, setLocationData, setLocationDataOption, setAnimatePause, setAnimateReverse, setSecPerHour, setMultiplySpeed, setClicked, setRoutePaths, setDefaultPitch, setMovesOptionFunc, setDepotsOptionFunc, setExtractedDataFunc, setLinemapData, setLoading, setInputFilename, updateMovesBase, setNoLoop, setInitialViewChange, setIconGradationChange, setTimeBegin, setTimeLength, addMovesBaseData } from '../actions';
...
reducer.case(setLocationData, (state, data) => {
    const assignData = {};
    if ('id' in data) {
