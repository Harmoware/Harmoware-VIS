import { addMinutes, setTime, setLeading, setTrailing, setViewport, setDefaultViewport, setLightSettings, setMovesBase, setDepotsBase, setAnimatePause, setAnimateReverse, setSecPerHour, setClicked, setRoutePaths, setDefaultZoom, setDefaultPitch, setMovesOptionFunc, setDepotsOptionFunc, setLoading, increaseTime, decreaseTime, setFrameTimestamp, setTimeStamp, setLinemapData, setInputFilename, updateMovesBase } from './actions';
