import { addMinutes, setTime, setLeading, setTrailing, setViewport, setDefaultViewport, setMovesBase, setDepotsBase, setAnimatePause, setAnimateReverse, setSecPerHour, setMultiplySpeed, setClicked, setRoutePaths, setDefaultZoom, setDefaultPitch, setMovesOptionFunc, setDepotsOptionFunc, setExtractedDataFunc, setLoading, increaseTime, decreaseTime, setFrameTimestamp, setTimeStamp, setLinemapData, setInputFilename, updateMovesBase, setNoLoop, setInitialViewChange, setIconGradationChange, setTimeBegin, setTimeLength, addMovesBaseData, } from './actions';
