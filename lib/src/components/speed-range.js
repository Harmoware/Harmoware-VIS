...
var SpeedRange = /** @class */ (function (_super) {
    ...
    SpeedRange.prototype.render = function () {
        var _a = this.props, secperhour = _a.secperhour, maxsecperhour = _a.maxsecperhour, min = _a.min, step = _a.step, id = _a.id, className = _a.className;
        return (React.createElement("input", { type: "range", value: (maxsecperhour + min) - secperhour, min: min, max: maxsecperhour, step: step, onChange: this.setSecPerHour.bind(this), id: id, className: className }));
    };
