...
const MovesInput = (props) => {
    ...
    const Result = React.useMemo(() => React.createElement("input", { type: "file", accept: ".json", id: id, className: className, style: style, onClick: onClick, onChange: onSelect }), [props]);
    return Result;
};
