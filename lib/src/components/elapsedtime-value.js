...
var ElapsedTimeValue = /** @class */ (function (_super) {
    ...
    ElapsedTimeValue.prototype.render = function () {
        ...
        return (React.createElement("input", { type: "number", value: (settime - timeBegin) | 0, min: min, max: timeLength, onChange: this.setTime.bind(this), id: id, className: className }));
    };
