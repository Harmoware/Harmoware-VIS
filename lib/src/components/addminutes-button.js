...
const AddMinutesButton = (props) => {
    ...
    const title = React.useMemo(() => propTitle || (children && children.toString()) || `${prop_addMinutes} ${i18n.minutesCaption}`, [propTitle, children, prop_addMinutes, i18n.minutesCaption]);
