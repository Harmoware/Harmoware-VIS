...
var OrbitController = /** @class */ (function (_super) {
    ...
    OrbitController.getViewport = function (viewport) {
        ...
        var outvec3 = vec3.create();
        var cameraPos = vec3.add(outvec3, lookAt, [0, 0, distance]);
    ...
    OrbitController.prototype.onDrag = function (evt) {
        if (this.dragStartPos) {
            ...
            if (evt.shiftKey || evt.ctrlKey || evt.altKey || evt.metaKey) {
                ...
                var outvec3 = vec3.create();
                var newLookAt = vec3.add(outvec3, lookAt, [-unitsPerPixel * dx, unitsPerPixel * dy, 0]);
                this.props.onViewportChange({
                    lookAt: newLookAt
                });
            }
    ...
    OrbitController.prototype.onDragEnd = function (evt) {
