    ...
    NavigationButton.prototype.render = function () {
        ...
        switch (buttonType) {
            case 'zoom-in': {
                ...
                return (React.createElement("button", { onClick: this.setViewport.bind(this, { zoom: zoom }), className: className }, "\uFF0B"));
            }
            case 'zoom-out': {
            ...
            case 'compass': {
                ...
                return (React.createElement("button", { onClick: this.setDefaultViewport.bind(this), className: className },
