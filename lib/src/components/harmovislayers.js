...
const MapGl = (props) => {
    const { mapboxAddLayerValue } = props, otherProps = __rest(props, ["mapboxAddLayerValue"]);
...
export default class HarmoVisLayers extends React.Component {
    ...
    render() {
        const { props } = this;
        const { actions, visible, viewport, mapStyle, mapboxApiAccessToken, layers, mapGlComponents, flytoArgument, mapboxAddLayerValue } = props;
