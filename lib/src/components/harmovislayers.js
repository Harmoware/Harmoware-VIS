...
var HarmoVisLayers = /** @class */ (function (_super) {
    ...
    HarmoVisLayers.prototype.render = function () {
        var _a = this.props, viewport = _a.viewport, mapStyle = _a.mapStyle, actions = _a.actions, mapboxApiAccessToken = _a.mapboxApiAccessToken, layers = _a.layers, mapGlComponents = _a.mapGlComponents, mapboxAddLayerValue = _a.mapboxAddLayerValue;
        var onViewportChange = this.props.onViewportChange || actions.setViewport;
        return (React.createElement(MapGl, __assign({}, viewport, { mapStyle: mapStyle, onViewportChange: onViewportChange, mapboxApiAccessToken: mapboxApiAccessToken }),
            mapGlComponents,
