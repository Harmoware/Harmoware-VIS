...
const HarmoVisLayers = (props) => {
    ...
    if (visible) {
        ...
        return (React.createElement(InteractiveMap, Object.assign({}, viewport, { onViewportChange: onViewportChange, mapboxApiAccessToken: mapboxApiAccessToken, visible: visible, transitionDuration: transitionDuration, transitionInterruption: transitionInterruption }),
            mapGlComponents,
            React.createElement(DeckGL, Object.assign({}, deckGLProps, { viewState: viewport, layers: layers, onWebGLInitialized: initialize }))));
    }
};
