...
var HarmoVisLayers = /** @class */ (function (_super) {
    ...
    HarmoVisLayers.prototype.setViewport = function (viewport) {
    ...
    HarmoVisLayers.prototype.render = function () {
        var _a = this.props, visible = _a.visible, viewport = _a.viewport, mapStyle = _a.mapStyle, actions = _a.actions, mapboxApiAccessToken = _a.mapboxApiAccessToken, layers = _a.layers, mapGlComponents = _a.mapGlComponents, flyto = _a.flyto, flytoArgument = _a.flytoArgument;
        var onViewportChange = this.props.onViewportChange ||
            flyto ? this.setViewport.bind(this) : actions.setViewport;
        return (React.createElement(MapGl, __assign({}, viewport, { mapStyle: mapStyle, onViewportChange: onViewportChange, mapboxApiAccessToken: mapboxApiAccessToken, visible: visible, transitionDuration: flyto ? this.transitionDuration : null, transitionInterpolator: new FlyToInterpolator(flytoArgument) }),
            mapGlComponents,
