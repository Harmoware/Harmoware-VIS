...
var HarmoVisLayers = /** @class */ (function (_super) {
    ...
    function HarmoVisLayers(props) {
        ...
        _this.state = { flyto: false };
        _this.transitionDuration = undefined;
    ...
    HarmoVisLayers.prototype.componentDidUpdate = function (prevProps) {
        if (this.state.flyto !== this.props.flyto) {
            ...
            var _a = this.props, flyto = _a.flyto, tran = _a.transitionDuration;
    ...
    HarmoVisLayers.prototype.onViewportChange = function (viewState) {
        var _a = this.props, actions = _a.actions, tran = _a.transitionDuration;
        var flyto = this.state.flyto; //必要！
        this.transitionDuration = undefined;
        actions.setViewport(viewState);
        this.transitionDuration = flyto ? (tran ? tran : 'auto') : undefined;
    };
    HarmoVisLayers.prototype.render = function () {
        var _a = this.props, visible = _a.visible, viewport = _a.viewport, mapStyle = _a.mapStyle, mapboxApiAccessToken = _a.mapboxApiAccessToken, layers = _a.layers, mapGlComponents = _a.mapGlComponents, flytoArgument = _a.flytoArgument;
        var onViewportChange = this.props.onViewportChange || this.onViewportChange.bind(this);
        var transitionDuration = viewport.transitionDuration || this.transitionDuration;
        var transitionInterpolator = viewport.transitionInterpolator || new FlyToInterpolator(flytoArgument);
        return (React.createElement(MapGl, __assign({}, viewport, { mapStyle: mapStyle, onViewportChange: onViewportChange, mapboxApiAccessToken: mapboxApiAccessToken, visible: visible, transitionDuration: transitionDuration, transitionInterpolator: transitionInterpolator, transitionInterruption: viewport.transitionInterruption }),
            mapGlComponents,
