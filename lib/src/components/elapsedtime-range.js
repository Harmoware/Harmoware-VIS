...
var ElapsedTimeRange = /** @class */ (function (_super) {
    ...
    ElapsedTimeRange.prototype.render = function () {
        ...
        var title = propTitle || "" + Math.floor(settime - timeBegin);
        return (React.createElement("input", { type: "range", value: Math.floor(settime - timeBegin), min: min, max: timeLength, step: step, onChange: this.setTime.bind(this), id: id, className: className, title: title }));
    };
