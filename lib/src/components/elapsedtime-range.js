...
const ElapsedTimeRange = (props) => {
    ...
    return (React.createElement("input", { type: "range", value: safeSubtract(settime, timeBegin) | 0, min: min, max: timeLength, step: step, onChange: setTime.bind(this), id: id, className: className, title: title }));
};
