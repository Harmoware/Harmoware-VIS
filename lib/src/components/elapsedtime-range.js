...
var ElapsedTimeRange = /** @class */ (function (_super) {
    ...
    ElapsedTimeRange.prototype.render = function () {
        ...
        var title = propTitle || "" + ((settime - timeBegin) | 0);
        return (React.createElement("input", { type: "range", value: (settime - timeBegin) | 0, min: min, max: timeLength, step: step, onChange: this.setTime.bind(this), id: id, className: className, title: title }));
    };
