...
var Container = /** @class */ (function (_super) {
    ...
    Container.prototype.animate = function () {
        var _a = this.props, timeLength = _a.timeLength, animatePause = _a.animatePause, loopEndPause = _a.loopEndPause, animateReverse = _a.animateReverse, actions = _a.actions;
        if (timeLength > 0) {
