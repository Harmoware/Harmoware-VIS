...
import { DepotsInput, AddMinutesButton, PlayButton, PauseButton, ReverseButton, ForwardButton, ElapsedTimeRange, ElapsedTimeValue, SpeedRange, SpeedValue, SimulationDateTime, NavigationButton } from 'harmoware-vis';
...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.deleteMovebase = function (maxKeepSecond) {
    ...
    Controller.prototype.render = function () {
        var _a = this.props, settime = _a.settime, timeBegin = _a.timeBegin, leading = _a.leading, timeLength = _a.timeLength, actions = _a.actions, secperhour = _a.secperhour, animatePause = _a.animatePause, animateReverse = _a.animateReverse, getMoveDataChecked = _a.getMoveDataChecked, getMoveOptionChecked = _a.getMoveOptionChecked, getDepotOptionChecked = _a.getDepotOptionChecked, getOptionChangeChecked = _a.getOptionChangeChecked, inputFileName = _a.inputFileName, viewport = _a.viewport;
        ...
        var depotsFileName = inputFileName.depotsFileName;
                ...
                React.createElement("ul", { className: "list-group harmovis_controller__list" },
                    ...
                    React.createElement("li", { className: "harmovis_controller__list__item" },
                        ...
                        React.createElement("div", { className: "btn-group d-flex", role: "group" },
                            ...
                            React.createElement(AddMinutesButton, { addMinutes: -1, actions: actions, className: "btn btn-outline-light btn-sm w-100" })),
                        React.createElement("div", { className: "btn-group d-flex", role: "group" },
                            React.createElement(AddMinutesButton, { addMinutes: 1, actions: actions, className: "btn btn-outline-light btn-sm w-100" }),
                            React.createElement(AddMinutesButton, { addMinutes: 5, actions: actions, className: "btn btn-outline-light btn-sm w-100" }))),
                    React.createElement("li", { className: "harmovis_controller__list__item" },
                        "\u518D\u73FE\u4E2D\u65E5\u6642\u00A0",
                        React.createElement(SimulationDateTime, { settime: settime })),
                    React.createElement("li", { className: "harmovis_controller__list__item" },
                        React.createElement("label", { htmlFor: "ElapsedTimeRange" },
                            ...
                            timeLength,
                            "\u00A0\u79D2"),
                        React.createElement(ElapsedTimeRange, { settime: settime, timeLength: timeLength, timeBegin: timeBegin, min: -leading, actions: actions, id: "ElapsedTimeRange", className: "form-control-range" })),
                    React.createElement("li", { className: "harmovis_controller__list__item" },
                    ...
                    React.createElement("li", { className: "harmovis_controller__list__item" },
                        React.createElement("div", null, "\u79FB\u52D5\u30C7\u30FC\u30BF\u64CD\u4F5C"),
                        React.createElement("div", { className: "btn-group d-flex", role: "group" },
                            React.createElement("button", { onClick: this.deleteMovebase.bind(this, 60), className: "btn btn-outline-light btn-sm w-100" },
