...
export var updateRainfall = function (settime, xbandCellSize, answer, xbandFname) { return ({ type: types.UPDATERAINFALL, settime: settime, xbandCellSize: xbandCellSize, answer: answer, xbandFname: xbandFname }); };
/** reducer * */
...
export var setBusTripsCsv = function (bustripscsv) { return ({ type: types.SETBUSTRIPSCSV, bustripscsv: bustripscsv }); };
export var setBusstopsCsv = function (busstopscsv) { return ({ type: types.SETBUSSTOPSCSV, busstopscsv: busstopscsv }); };
