...
exports.connectToHarmowareVis = exports.defaultMapStateToProps = exports.analyzelinemapData = exports.getClickedObjectToBeRemoved = exports.getMoveObjects = exports.getDepots = exports.analyzeDepotsBase = exports.analyzeMovesBase = exports.calcLoopTime = exports.getContainerProp = undefined;
    ...
    if (typeof departuretime !== 'number' || typeof arrivaltime !== 'number') {
      ...
      for (var j = 0, lengthj = operation.length; j < lengthj - 1; j += 1) {
        ...
        var _operation = operation[j + 1],
            ...
            nextposition = _operation.position;
...
var analyzelinemapData = exports.analyzelinemapData = function analyzelinemapData(nonmapView, linemapData) {
  ...
  for (var j = 0, lengthj = linemapData.length; j < lengthj; j += 1) {
    var _linemapData$j = linemapData[j],
        sourcePosition = _linemapData$j.sourcePosition,
        targetPosition = _linemapData$j.targetPosition;
