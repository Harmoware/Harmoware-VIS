    ...
    value: function onDrag(evt) {
      if (this.dragStartPos) {
        ...
        if (evt.shiftKey || evt.ctrlKey || evt.altKey || evt.metaKey) {
          ...
          var newRotationX = clamp(rotationX - dy * 180, -90, 90);
          var newRotationY = (rotationY - dx * 180) % 360;
          ...
          _glMatrix.vec3.rotateX(newLookAt, newLookAt, lookAt, _rotationX / 180 * Math.PI);
          _glMatrix.vec3.rotateY(newLookAt, newLookAt, lookAt, _rotationY / 180 * Math.PI);
